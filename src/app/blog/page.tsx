...
import { safeFetch, postsQuery, isSanityConfigured } from "@/sanity/lib/client";
...
function PostCard({ post }: { post: Post }) {
  ...
  return (
    <Link href={`/blog/${slug}`} className="group">
      <article className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
        {/* Post Image */}
        {mainImage?.asset && (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 text-lg max-w-2xl mx-auto">
              Artículos, noticias y actualizaciones sobre auditoría, finanzas y
